...
public class level4_Fragment extends Fragment {
    ...
    public static void newExercise() {
        ...
        if (stage == 1) {
            while(b==0||a%b!=0){               //شرط باقي القسمة يكون 0 والعدد المقسوم عليه !=0
                a = (int) (Math.random() * 10);  // العددان احاديان المنزلة
        ...
        if (stage == 2) {
            while(b==0||a%b!=0){
                a = (int) (Math.random() * 90)+10; //عدد احادي المنزلة وعدد ثنائي
                b = (int) (Math.random() * 10);
            }
        }
        ...
        if (stage == 3) {
            while(b==0||a%b!=0){
                a = (int) (Math.random() * 900) + 100; //عدد احادي المنزلة وعدد ثلاثي
                b = (int) (Math.random() * 10) ;
            }
        }
