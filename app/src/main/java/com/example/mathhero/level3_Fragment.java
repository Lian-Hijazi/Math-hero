...
public class level3_Fragment extends Fragment {
    ...
    public static void newExercise() {
        ...
        int  a = (int) (Math.random() * 10),b=0;            //العدد الاول دائما احادي المنزلة

        if (stage == 1) b = (int) (Math.random() * 10);     //العدد الثاني احادي المنزلة

        if (stage == 2) b = (int) (Math.random() * 90)+10;    //العدد الثاني ثنائي المنزلة

        if (stage == 3) b = (int) (Math.random() * 900) + 100;    //العدد الثاني ثلاثي المنزلة
