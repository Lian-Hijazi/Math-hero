...
public class level2_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_level2_, container, false);
            ...
            public void onClick(View v) {
                ...
                new android.app.AlertDialog.Builder(getActivity())
                        ...
                        .setPositiveButton("Yes", (dialog, which) -> {
                            ...
                            MainActivity.level2_frame.setVisibility(View.INVISIBLE);
                        })
    ...
    public static void newExercise() {
        ...
        if (stage == 1) {
            while(a<b){                             //اعداد احادية المنازل ونتيجتها موجبة
                a = (int) (Math.random() * 10);
                b = (int) (Math.random() * 10);
            }
        }

        if (stage == 2) {                           //اعداد ثنائية المنازل ونتيجتها موجبة
            while(a<b){
        ...
        if (stage == 3) {                           //اعداد ثلاثية المنازل ونتيجتها موجبة
            while (a<b) {
    ...
    public void finish() {                                //احتفال اختتام المرحلة وتغديل المتغيرات
        MainActivity.updateLevel(2, getContext());
        MainActivity.is_playing = false;
        MainActivity.Home_frame.setVisibility(View.VISIBLE);
        MainActivity.level2_frame.setVisibility(View.INVISIBLE);
